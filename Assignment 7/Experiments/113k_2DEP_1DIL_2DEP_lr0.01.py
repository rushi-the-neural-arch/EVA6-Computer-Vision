...
================================================================
      ...
      BatchNorm2d-71           [-1, 32, 24, 24]              64
        Dropout2d-72           [-1, 32, 24, 24]               0
           Conv2d-73           [-1, 32, 24, 24]             288
           Conv2d-74           [-1, 32, 24, 24]           1,024
             ReLU-75           [-1, 32, 24, 24]               0
      BatchNorm2d-76           [-1, 32, 24, 24]              64
        Dropout2d-77           [-1, 32, 24, 24]               0
           Conv2d-78           [-1, 32, 24, 24]             288
           Conv2d-79           [-1, 32, 24, 24]           1,024
             ReLU-80           [-1, 32, 24, 24]               0
      BatchNorm2d-81           [-1, 32, 24, 24]              64
        Dropout2d-82           [-1, 32, 24, 24]               0
           Conv2d-83           [-1, 32, 22, 22]           9,216
             ReLU-84           [-1, 32, 22, 22]               0
      BatchNorm2d-85           [-1, 32, 22, 22]              64
        Dropout2d-86           [-1, 32, 22, 22]               0
           Conv2d-87           [-1, 32, 22, 22]             288
           Conv2d-88           [-1, 32, 22, 22]           1,024
             ReLU-89           [-1, 32, 22, 22]               0
      BatchNorm2d-90           [-1, 32, 22, 22]              64
        Dropout2d-91           [-1, 32, 22, 22]               0
           Conv2d-92           [-1, 32, 22, 22]             288
           Conv2d-93           [-1, 32, 22, 22]           1,024
             ReLU-94           [-1, 32, 22, 22]               0
      BatchNorm2d-95           [-1, 32, 22, 22]              64
        Dropout2d-96           [-1, 32, 22, 22]               0
           Conv2d-97           [-1, 32, 20, 20]           9,216
     ...
     BatchNorm2d-105           [-1, 32, 20, 20]              64
       Dropout2d-106           [-1, 32, 20, 20]               0
          Conv2d-107           [-1, 32, 20, 20]             288
          Conv2d-108           [-1, 32, 20, 20]           1,024
            ReLU-109           [-1, 32, 20, 20]               0
     BatchNorm2d-110           [-1, 32, 20, 20]              64
       Dropout2d-111           [-1, 32, 20, 20]               0
          Conv2d-112           [-1, 32, 20, 20]             288
          Conv2d-113           [-1, 32, 20, 20]           1,024
            ReLU-114           [-1, 32, 20, 20]               0
     BatchNorm2d-115           [-1, 32, 20, 20]              64
       Dropout2d-116           [-1, 32, 20, 20]               0
          Conv2d-117           [-1, 32, 18, 18]           9,216
            ReLU-118           [-1, 32, 18, 18]               0
     BatchNorm2d-119           [-1, 32, 18, 18]              64
       Dropout2d-120           [-1, 32, 18, 18]               0
          Conv2d-121           [-1, 32, 18, 18]             288
          Conv2d-122           [-1, 32, 18, 18]           1,024
            ReLU-123           [-1, 32, 18, 18]               0
     BatchNorm2d-124           [-1, 32, 18, 18]              64
       Dropout2d-125           [-1, 32, 18, 18]               0
          Conv2d-126           [-1, 32, 18, 18]             288
          Conv2d-127           [-1, 32, 18, 18]           1,024
            ReLU-128           [-1, 32, 18, 18]               0
     BatchNorm2d-129           [-1, 32, 18, 18]              64
       Dropout2d-130           [-1, 32, 18, 18]               0
          Conv2d-131           [-1, 32, 16, 16]           9,216
            ReLU-132           [-1, 32, 16, 16]               0
     BatchNorm2d-133           [-1, 32, 16, 16]              64
       Dropout2d-134           [-1, 32, 16, 16]               0
          Conv2d-135           [-1, 10, 16, 16]             320
            ReLU-136           [-1, 10, 16, 16]               0
